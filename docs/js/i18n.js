...
const translations = {
  en: {
    ...
    createUserDesc: 'Add a new account for admin, teacher, parent, or student roles.',
    userDirectory: 'User directory',
    userDirectoryDesc: 'Browse, update roles, reset passwords, and manage account status.',
    subTabCreateUser: 'Create user',
    subTabUserDirectory: 'User directory',
    subTabAddStudent: 'Add student',
    subTabStudentDirectory: 'Student directory',
    addStudentDesc: 'Register a new student in the school directory.',
    studentDirectoryDesc: 'View students by class, link parents, and manage records.',
    subTabAssignClass: 'Assign class',
    subTabAssignmentsDirectory: 'Assignments directory',
    assignmentsDirectory: 'Assignments directory',
    assignmentsDirectoryDesc: 'Filter and review teacher class assignments.',
    subTabScheduleDirectory: 'View timetable',
    subTabAddSchedule: 'Add entry',
    subTabSchoolSummary: 'School summary',
    subTabClassMatrix: 'Class matrix',
    schoolGradebookSummary: 'School gradebook summary',
    schoolGradebookSummaryDesc: 'Overview of formative assessment progress across all classes.',
    students: 'Students',
    ...
    noGradebookSummary: 'No assessment data yet.',
    selectTimeSlot: 'Select period',
    breakPeriod: 'Break',
    addScheduleDesc: 'Add a period to the class timetable. Select grade and section first.',
  ...
  ar: {
    ...
    createUserDesc: 'إضافة حساب جديد لمسؤول أو معلم أو ولي أمر أو طالب.',
    userDirectory: 'دليل المستخدمين',
    userDirectoryDesc: 'استعراض الحسابات وتحديث الأدوار وإعادة تعيين كلمات المرور.',
    subTabCreateUser: 'إنشاء مستخدم',
    subTabUserDirectory: 'دليل المستخدمين',
    subTabAddStudent: 'إضافة طالب',
    subTabStudentDirectory: 'دليل الطلاب',
    addStudentDesc: 'تسجيل طالب جديد في دليل المدرسة.',
    studentDirectoryDesc: 'عرض الطلاب حسب الصف وربط أولياء الأمور وإدارة السجلات.',
    subTabAssignClass: 'تعيين صف',
    subTabAssignmentsDirectory: 'دليل التعيينات',
    assignmentsDirectory: 'دليل التعيينات',
    assignmentsDirectoryDesc: 'تصفية ومراجعة تعيينات المعلمين للصفوف.',
    subTabScheduleDirectory: 'عرض الجدول',
    subTabAddSchedule: 'إضافة حصة',
    subTabSchoolSummary: 'ملخص المدرسة',
    subTabClassMatrix: 'مصفوفة الصف',
    schoolGradebookSummary: 'ملخص سجل درجات المدرسة',
    schoolGradebookSummaryDesc: 'نظرة عامة على تقدم التقييمات التكوينية في جميع الصفوف.',
    students: 'الطلاب',
    ...
    atRisk: 'معرضون للخطر',
    viewClass: 'عرض الصف',
    noGradebookSummary: 'لا توجد بيانات تقييم بعد.',
    selectTimeSlot: 'اختر الحصة',
    breakPeriod: 'استراحة',
    addScheduleDesc: 'إضافة حصة إلى جدول الصف. اختر الصف والشعبة أولاً.',
